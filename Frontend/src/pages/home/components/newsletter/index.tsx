const NewsLetter = () => {
  return (
    <div
      className="bg-gray-100 dark:bg-slate-500 py-20 px-10 rounded-md mb-20  justify-center items-center gap-5
    flex
    flex-col
    md:flex-row
        ...
        <div className="flex flex-col md:flex-row mt-10">
          <div className="flex mt-4">
            <input
              ...
              className="w-96 h-12 rounded-l-lg px-4 border border-gray-300 outline-none focus:border-primary-400"
            />
            <button className="w-32 h-12 bg-primary-400 rounded-r-lg text-white font-bold">
              Subscribe
            </button>
          </div>
        </div>
