...
const ValuesItem = ({
  ...
  return (
    <div className=" rounded-lg shadow-lg p-5 flex flex-col justify-between items-center space-y-5 hover:shadow-2xl transition duration-200 ease-in-out dark:bg-slate-700 cursor-pointer">
      <div className=" rounded-full bg- text-primary-400 w-32 h-32 flex justify-center items-center text-7xl">
        {icon}
      </div>
      <h1 className=" text-2xl font-semibold text-gray-800 dark:text-gray-50 text-center ">
        {title}
      </h1>
      <p className=" text-gray-600 dark:text-gray-300 text-center px-5">
        {description}
      </p>
    </div>
  );
...
const VisionValues = () => {
  return (
    <div className=" flex flex-col justify-center items-center space-y-5 w-full px-10 py-20 bg-gray-100 dark:bg-slate-600 mb-10">
