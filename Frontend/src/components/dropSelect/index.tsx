  ...
  return (
    <div className="flex flex-col w-full mb-5  dark:text-gray-100">
      ...
      <select
        ...
        className=" w-full h-14 px-5 py-3 mb-3 border-2 border-gray-300 rounded-lg dark:border-gray-600 focus:outline-none focus:border-primary-400 dark:bg-gray-800 dark:text-gray-100"
        id={""}
