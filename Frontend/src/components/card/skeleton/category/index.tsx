const CategoryCardSkeleton = () => {
  return (
    <div className="max-w-sm border border-gray-200 rounded-xl shadow animate-pulse duration-200  dark:border-gray-700">
      ...
      <div className="p-4">
        <div className="flex items-end justify-between mb-4 space-x-3">
          ...
          <div>
            <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-14 mb-2"></div>
          </div>
        </div>
